...
// name variables and concat after!
        ...
        // document.getElementById("names").innerHTML = characterNames[i];
        // document.getElementById("bio").innerHTML = bio[i];
        // document.getElementById("ally").innerHTML = isAlly[i];
        // document.getElementById("bondgirl").innerHTML = isBondGirl[i];
